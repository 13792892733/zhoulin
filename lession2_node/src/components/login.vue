               ...
               <td>
                 <input type="text" v-model="keycode"
                  class="form-control pull-left"  placeholder="验证码"
                   ...
                   <img @click="changeKeycode($event)" id="sys_keycode" class="pull-left" src="http://192.168.1.157:8085/project_mgj/KaptchaController" />
  ...
  export default{
    ...
    ,methods:{
      ...
      changeKeycode(event){
        ...
        event.target.src="http://192.168.1.157:8085/project_mgj/KaptchaController";
      ...
      doRegiste(){
       ...
       if(ob.keycode.length==""){
        ...
        var url="hhttp://192.168.1.157:8085/project_mgj/IntoSupplier";
        $.ajax(url,{
          data:{
            logname:ob.logname,
          ...
          success:function(result){
            if(result.msg==1){
              ...
              ob.showmsg=true;
              if(result.msg!=1){
                $("#sys_keycode")[0].src="http://192.168.1.157:8085/project_mgj/KaptchaController";
              }
            }
